...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = 3453.8193122294015; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = -5531.664284909901; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -5077.335906382187; // x position of the perpendicular encoder (in tick units)
    }
