...
public class CloseBlueAuto extends LinearOpMode {
    ...
    private static final Pose2d PICKUP1_POSE1 = new Pose2d(-30, 12, Math.toRadians(345));
    private static final Pose2d PICKUP1_POSE2 = new Pose2d(-66, 12, Math.toRadians(360));
    ...
    //asasasa
    private static final Pose2d PICKUP3_POSE1 = new Pose2d(-30, -36, Math.toRadians(345));
    private static final Pose2d PICKUP3_POSE2 = new Pose2d(-62, -36, Math.toRadians(360));
