...
//
//@Autonomous(name = "Blue12BallClose")
//public class CloseBlueAuto extends LinearOpMode {
//    private static final Pose2d STARTING_POSE = new Pose2d(-55.5, 52, Math.toRadians(130));
//    private static final Pose2d SHOOT_POSE = new Pose2d(-31, 27.5, Math.toRadians(135));
//    private static final Pose2d SHOOT_POSE1 = new Pose2d(-33, 27.5, Math.toRadians(130));
//
//    private static final Pose2d SHOOT_POSE2 = new Pose2d(-33, 27.5, Math.toRadians(150));
//    private static final Pose2d SHOOT_POSE3 = new Pose2d(-33, 27.5, Math.toRadians(180));
//    private static final Pose2d PICKUP1_POSE1 = new Pose2d(-30, 12, Math.toRadians(165));
//    private static final Pose2d PICKUP1_POSE2 = new Pose2d(-66, 12, Math.toRadians(180));
//    private static final Pose2d PICKUP2_POSE1 = new Pose2d(-30, -12, Math.toRadians(165));
//    private static final Pose2d PICKUP2_POSE2 = new Pose2d(-66, -12, Math.toRadians(180));
//    //asasasa
//    private static final Pose2d PICKUP3_POSE1 = new Pose2d(-30, -36, Math.toRadians(165));
//    private static final Pose2d PICKUP3_POSE2 = new Pose2d(-62, -36, Math.toRadians(180));
