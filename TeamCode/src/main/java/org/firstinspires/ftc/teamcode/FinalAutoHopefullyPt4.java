...
//    private static final Pose2d STARTING_POSE = new Pose2d(-23, 53, Math.toRadians(140));
//    private static final Pose2d SHOOT_POSE = new Pose2d(0, 36, Math.toRadians(140));
//    private static final Pose2d SHOOT_POSE1 = new Pose2d(6, 36, Math.toRadians(120));
//
//    private static final Pose2d SHOOT_POSE2 = new Pose2d(2, 50, Math.toRadians(135));
//    private static final Pose2d SHOOT_POSE3 = new Pose2d(2, 75, Math.toRadians(170));
//    private static final Pose2d PICKUP1_POSE1 = new Pose2d(7, 8, Math.toRadians(165));
//    private static final Pose2d PICKUP1_POSE2 = new Pose2d(-28, 14, Math.toRadians(180));
//    private static final Pose2d PICKUP2_POSE1 = new Pose2d(7, -14, Math.toRadians(165));
//    private static final Pose2d PICKUP2_POSE2 = new Pose2d(-28, -8, Math.toRadians(180));
//    //asasasa
//    private static final Pose2d PICKUP3_POSE1 = new Pose2d(-7, -47, Math.toRadians(165));
//    private static final Pose2d PICKUP3_POSE2 = new Pose2d(-28, -47, Math.toRadians(180));
